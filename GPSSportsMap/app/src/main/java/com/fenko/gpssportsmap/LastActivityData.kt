...
class LastActivityData : AppCompatActivity(), OnMapReadyCallback {
    /*
    Activity Class. Shows last gpsActivity data and track on map fragment.
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //getting last/current gps activity and user from database
        activity = activityRepo.getLast()
